...
export class Migrations1768982743579 implements MigrationInterface {
    name = 'Migrations1768982743579'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "projects" ADD "organizationId" character varying NOT NULL`);
